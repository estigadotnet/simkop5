...
$t89_rektran_edit = NULL; // Initialize page object first

class ct89_rektran_edit extends ct89_rektran {
	...
	// Page object name
	var $PageObjName = 't89_rektran_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t89_rektranlist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t89_rektranlist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "t89_rektranlist.php")
...
// Create page object
if (!isset($t89_rektran_edit)) $t89_rektran_edit = new ct89_rektran_edit();

// Page init
$t89_rektran_edit->Page_Init();

// Page main
$t89_rektran_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t89_rektran_edit->Page_Render();
?>
...
var CurrentForm = ft89_rektranedit = new ew_Form("ft89_rektranedit", "edit");

// Validate form
ft89_rektranedit.Validate = function() {
...
ft89_rektranedit.Form_CustomValidate = 
...
ft89_rektranedit.ValidateRequired = true;
<?php } else { ?>
ft89_rektranedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft89_rektranedit.Lists["x_DebetRekening"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_id","x_rekening","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t91_rekening"};
ft89_rektranedit.Lists["x_KreditRekening"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_id","x_rekening","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t91_rekening"};
...
<?php if (!$t89_rektran_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t89_rektran_edit->ShowPageHeader(); ?>
<?php
$t89_rektran_edit->ShowMessage();
?>
<form name="ft89_rektranedit" id="ft89_rektranedit" class="<?php echo $t89_rektran_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t89_rektran_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t89_rektran_edit->Token ?>">
<?php } ?>
...
<?php if ($t89_rektran->KodeTransaksi->Visible) { // KodeTransaksi ?>
	<div id="r_KodeTransaksi" class="form-group">
		<label id="elh_t89_rektran_KodeTransaksi" for="x_KodeTransaksi" class="col-sm-2 control-label ewLabel"><?php echo $t89_rektran->KodeTransaksi->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t89_rektran->KodeTransaksi->CellAttributes() ?>>
<span id="el_t89_rektran_KodeTransaksi">
<input type="text" data-table="t89_rektran" data-field="x_KodeTransaksi" name="x_KodeTransaksi" id="x_KodeTransaksi" size="30" maxlength="2" placeholder="<?php echo ew_HtmlEncode($t89_rektran->KodeTransaksi->getPlaceHolder()) ?>" value="<?php echo $t89_rektran->KodeTransaksi->EditValue ?>"<?php echo $t89_rektran->KodeTransaksi->EditAttributes() ?>>
</span>
<?php echo $t89_rektran->KodeTransaksi->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t89_rektran->JenisTransaksi->Visible) { // JenisTransaksi ?>
	<div id="r_JenisTransaksi" class="form-group">
		<label id="elh_t89_rektran_JenisTransaksi" for="x_JenisTransaksi" class="col-sm-2 control-label ewLabel"><?php echo $t89_rektran->JenisTransaksi->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t89_rektran->JenisTransaksi->CellAttributes() ?>>
<span id="el_t89_rektran_JenisTransaksi">
<input type="text" data-table="t89_rektran" data-field="x_JenisTransaksi" name="x_JenisTransaksi" id="x_JenisTransaksi" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($t89_rektran->JenisTransaksi->getPlaceHolder()) ?>" value="<?php echo $t89_rektran->JenisTransaksi->EditValue ?>"<?php echo $t89_rektran->JenisTransaksi->EditAttributes() ?>>
</span>
<?php echo $t89_rektran->JenisTransaksi->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t89_rektran->DebetRekening->Visible) { // DebetRekening ?>
	<div id="r_DebetRekening" class="form-group">
		<label id="elh_t89_rektran_DebetRekening" for="x_DebetRekening" class="col-sm-2 control-label ewLabel"><?php echo $t89_rektran->DebetRekening->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t89_rektran->DebetRekening->CellAttributes() ?>>
<span id="el_t89_rektran_DebetRekening">
<select data-table="t89_rektran" data-field="x_DebetRekening" data-value-separator="<?php echo $t89_rektran->DebetRekening->DisplayValueSeparatorAttribute() ?>" id="x_DebetRekening" name="x_DebetRekening"<?php echo $t89_rektran->DebetRekening->EditAttributes() ?>>
<?php echo $t89_rektran->DebetRekening->SelectOptionListHtml("x_DebetRekening") ?>
</select>
<input type="hidden" name="s_x_DebetRekening" id="s_x_DebetRekening" value="<?php echo $t89_rektran->DebetRekening->LookupFilterQuery() ?>">
</span>
<?php echo $t89_rektran->DebetRekening->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t89_rektran->KreditRekening->Visible) { // KreditRekening ?>
	<div id="r_KreditRekening" class="form-group">
		<label id="elh_t89_rektran_KreditRekening" for="x_KreditRekening" class="col-sm-2 control-label ewLabel"><?php echo $t89_rektran->KreditRekening->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t89_rektran->KreditRekening->CellAttributes() ?>>
<span id="el_t89_rektran_KreditRekening">
<select data-table="t89_rektran" data-field="x_KreditRekening" data-value-separator="<?php echo $t89_rektran->KreditRekening->DisplayValueSeparatorAttribute() ?>" id="x_KreditRekening" name="x_KreditRekening"<?php echo $t89_rektran->KreditRekening->EditAttributes() ?>>
<?php echo $t89_rektran->KreditRekening->SelectOptionListHtml("x_KreditRekening") ?>
</select>
<input type="hidden" name="s_x_KreditRekening" id="s_x_KreditRekening" value="<?php echo $t89_rektran->KreditRekening->LookupFilterQuery() ?>">
</span>
<?php echo $t89_rektran->KreditRekening->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<input type="hidden" data-table="t89_rektran" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t89_rektran->id->CurrentValue) ?>">
<?php if (!$t89_rektran_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t89_rektran_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft89_rektranedit.Init();
</script>
<?php
$t89_rektran_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t89_rektran_edit->Page_Terminate();
?>
