...
$t89_rektran_add = NULL; // Initialize page object first

class ct89_rektran_add extends ct89_rektran {
	...
	// Page object name
	var $PageObjName = 't89_rektran_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t89_rektranview.php")
...
// Create page object
if (!isset($t89_rektran_add)) $t89_rektran_add = new ct89_rektran_add();

// Page init
$t89_rektran_add->Page_Init();

// Page main
$t89_rektran_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t89_rektran_add->Page_Render();
?>
...
var CurrentForm = ft89_rektranadd = new ew_Form("ft89_rektranadd", "add");

// Validate form
ft89_rektranadd.Validate = function() {
...
ft89_rektranadd.Form_CustomValidate = 
...
ft89_rektranadd.ValidateRequired = true;
<?php } else { ?>
ft89_rektranadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft89_rektranadd.Lists["x_DebetRekening"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_id","x_rekening","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t91_rekening"};
ft89_rektranadd.Lists["x_KreditRekening"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_id","x_rekening","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t91_rekening"};
...
<?php if (!$t89_rektran_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t89_rektran_add->ShowPageHeader(); ?>
<?php
$t89_rektran_add->ShowMessage();
?>
<form name="ft89_rektranadd" id="ft89_rektranadd" class="<?php echo $t89_rektran_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t89_rektran_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t89_rektran_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t89_rektran_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft89_rektranadd.Init();
</script>
<?php
$t89_rektran_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t89_rektran_add->Page_Terminate();
?>
