...
$t90_rektran_edit = NULL; // Initialize page object first

class ct90_rektran_edit extends ct90_rektran {
	...
	// Page object name
	var $PageObjName = 't90_rektran_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t90_rektranlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t90_rektran_edit)) $t90_rektran_edit = new ct90_rektran_edit();

// Page init
$t90_rektran_edit->Page_Init();

// Page main
$t90_rektran_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t90_rektran_edit->Page_Render();
?>
...
var CurrentForm = ft90_rektranedit = new ew_Form("ft90_rektranedit", "edit");

// Validate form
ft90_rektranedit.Validate = function() {
...
ft90_rektranedit.Form_CustomValidate = 
...
ft90_rektranedit.ValidateRequired = true;
<?php } else { ?>
ft90_rektranedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft90_rektranedit.Lists["x_KodeRekening"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_id","x_rekening","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t91_rekening"};
...
<?php if (!$t90_rektran_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t90_rektran_edit->ShowPageHeader(); ?>
<?php
$t90_rektran_edit->ShowMessage();
?>
<form name="ft90_rektranedit" id="ft90_rektranedit" class="<?php echo $t90_rektran_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t90_rektran_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t90_rektran_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t90_rektran" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t90_rektran->id->CurrentValue) ?>">
<?php if (!$t90_rektran_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t90_rektran_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft90_rektranedit.Init();
</script>
<?php
$t90_rektran_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t90_rektran_edit->Page_Terminate();
?>
