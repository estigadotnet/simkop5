...
$t11_jurnalmaster_edit = NULL; // Initialize page object first

class ct11_jurnalmaster_edit extends ct11_jurnalmaster {
	...
	// Page object name
	var $PageObjName = 't11_jurnalmaster_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t11_jurnalmasterlist.php"); // Invalid key, return to list
		}
	...
	function ValidateForm() {
		...
		if (in_array("t12_jurnaldetail", $DetailTblVar) && $GLOBALS["t12_jurnaldetail"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("t12_jurnaldetail", $DetailTblVar) && $GLOBALS["t12_jurnaldetail"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["t12_jurnaldetail_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t12_jurnaldetail", $DetailTblVar)) {
				...
				if ($GLOBALS["t12_jurnaldetail_grid"]->DetailEdit) {
					$GLOBALS["t12_jurnaldetail_grid"]->CurrentMode = "edit";
					$GLOBALS["t12_jurnaldetail_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($t11_jurnalmaster_edit)) $t11_jurnalmaster_edit = new ct11_jurnalmaster_edit();

// Page init
$t11_jurnalmaster_edit->Page_Init();

// Page main
$t11_jurnalmaster_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t11_jurnalmaster_edit->Page_Render();
?>
...
var CurrentForm = ft11_jurnalmasteredit = new ew_Form("ft11_jurnalmasteredit", "edit");

// Validate form
ft11_jurnalmasteredit.Validate = function() {
...
ft11_jurnalmasteredit.Form_CustomValidate = 
...
ft11_jurnalmasteredit.ValidateRequired = true;
<?php } else { ?>
ft11_jurnalmasteredit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t11_jurnalmaster_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t11_jurnalmaster_edit->ShowPageHeader(); ?>
<?php
$t11_jurnalmaster_edit->ShowMessage();
?>
<form name="ft11_jurnalmasteredit" id="ft11_jurnalmasteredit" class="<?php echo $t11_jurnalmaster_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t11_jurnalmaster_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t11_jurnalmaster_edit->Token ?>">
<?php } ?>
...
<?php if ($t11_jurnalmaster->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_t11_jurnalmaster_id" class="col-sm-2 control-label ewLabel"><?php echo $t11_jurnalmaster->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t11_jurnalmaster->id->CellAttributes() ?>>
<span id="el_t11_jurnalmaster_id">
<span<?php echo $t11_jurnalmaster->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t11_jurnalmaster->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t11_jurnalmaster" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t11_jurnalmaster->id->CurrentValue) ?>">
<?php echo $t11_jurnalmaster->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft11_jurnalmasteredit", "x_Tanggal", 7);
</script>
<?php } ?>
</span>
...
<?php
	if (in_array("t12_jurnaldetail", explode(",", $t11_jurnalmaster->getCurrentDetailTable())) && $t12_jurnaldetail->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t11_jurnalmaster_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft11_jurnalmasteredit.Init();
</script>
<?php
$t11_jurnalmaster_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t11_jurnalmaster_edit->Page_Terminate();
?>
