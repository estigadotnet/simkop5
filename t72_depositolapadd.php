...
$t72_depositolap_add = NULL; // Initialize page object first

class ct72_depositolap_add extends ct72_depositolap {
	...
	// Page object name
	var $PageObjName = 't72_depositolap_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t72_depositolapview.php")
...
// Create page object
if (!isset($t72_depositolap_add)) $t72_depositolap_add = new ct72_depositolap_add();

// Page init
$t72_depositolap_add->Page_Init();

// Page main
$t72_depositolap_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t72_depositolap_add->Page_Render();
?>
...
var CurrentForm = ft72_depositolapadd = new ew_Form("ft72_depositolapadd", "add");

// Validate form
ft72_depositolapadd.Validate = function() {
...
ft72_depositolapadd.Form_CustomValidate = 
...
ft72_depositolapadd.ValidateRequired = true;
<?php } else { ?>
ft72_depositolapadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft72_depositolapadd.Lists["x_field_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft72_depositolapadd.Lists["x_field_status"].Options = <?php echo json_encode($t72_depositolap->field_status->Options()) ?>;
ft72_depositolapadd.Lists["x_field_align"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft72_depositolapadd.Lists["x_field_align"].Options = <?php echo json_encode($t72_depositolap->field_align->Options()) ?>;
ft72_depositolapadd.Lists["x_field_format"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft72_depositolapadd.Lists["x_field_format"].Options = <?php echo json_encode($t72_depositolap->field_format->Options()) ?>;
...
<?php if (!$t72_depositolap_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t72_depositolap_add->ShowPageHeader(); ?>
<?php
$t72_depositolap_add->ShowMessage();
?>
<form name="ft72_depositolapadd" id="ft72_depositolapadd" class="<?php echo $t72_depositolap_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t72_depositolap_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t72_depositolap_add->Token ?>">
<?php } ?>
...
<?php if ($t72_depositolap->field_name->Visible) { // field_name ?>
	<div id="r_field_name" class="form-group">
		<label id="elh_t72_depositolap_field_name" for="x_field_name" class="col-sm-2 control-label ewLabel"><?php echo $t72_depositolap->field_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t72_depositolap->field_name->CellAttributes() ?>>
<span id="el_t72_depositolap_field_name">
<input type="text" data-table="t72_depositolap" data-field="x_field_name" name="x_field_name" id="x_field_name" size="30" maxlength="32" placeholder="<?php echo ew_HtmlEncode($t72_depositolap->field_name->getPlaceHolder()) ?>" value="<?php echo $t72_depositolap->field_name->EditValue ?>"<?php echo $t72_depositolap->field_name->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t72_depositolap_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft72_depositolapadd.Init();
</script>
<?php
$t72_depositolap_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t72_depositolap_add->Page_Terminate();
?>
