...
//
// Table class for t92_periodeold
//
class ct92_periodeold extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't92_periodeold';
		$this->TableName = 't92_periodeold';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t92_periodeold`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t92_periodeold', 't92_periodeold', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Bulan
		$this->Bulan = new cField('t92_periodeold', 't92_periodeold', 'x_Bulan', 'Bulan', '`Bulan`', '`Bulan`', 16, -1, FALSE, '`Bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tahun
		$this->Tahun = new cField('t92_periodeold', 't92_periodeold', 'x_Tahun', 'Tahun', '`Tahun`', '`Tahun`', 2, -1, FALSE, '`Tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tahun_Bulan
		$this->Tahun_Bulan = new cField('t92_periodeold', 't92_periodeold', 'x_Tahun_Bulan', 'Tahun_Bulan', '`Tahun_Bulan`', '`Tahun_Bulan`', 200, -1, FALSE, '`Tahun_Bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t92_periodeold`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t92_periodeoldview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t92_periodeoldview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t92_periodeoldadd.php?" . $this->UrlParm($parm);
		else
			$url = "t92_periodeoldadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t92_periodeoldedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t92_periodeoldadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t92_periodeolddelete.php", $this->UrlParm());
	}
