...
class ct95_logdesc_edit extends ct95_logdesc {
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t95_logdesclist.php"); // Invalid key, return to list
		}
...
<script type="text/javascript">
ew_CreateCalendar("ft95_logdescedit", "x_date_issued", 0);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ft95_logdescedit", "x_date_solved", 0);
</script>
<?php } ?>
</span>
