...
$t94_log_add = NULL; // Initialize page object first

class ct94_log_add extends ct94_log {
...
// Create page object
if (!isset($t94_log_add)) $t94_log_add = new ct94_log_add();

// Page init
$t94_log_add->Page_Init();

// Page main
$t94_log_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t94_log_add->Page_Render();
?>
...
var CurrentForm = ft94_logadd = new ew_Form("ft94_logadd", "add");

// Validate form
ft94_logadd.Validate = function() {
...
ft94_logadd.Form_CustomValidate = 
...
ft94_logadd.ValidateRequired = true;
<?php } else { ?>
ft94_logadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t94_log_add->ShowPageHeader(); ?>
<?php
$t94_log_add->ShowMessage();
?>
<form name="ft94_logadd" id="ft94_logadd" class="<?php echo $t94_log_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t94_log_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t94_log_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t94_log_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
