...
//
// Table class for t93_periode
//
class ct93_periode extends cTable {
	var $id;
	var $Bulan;
	var $Tahun;
	var $Tahun_Bulan;
	...
	function __construct() {
		...
		$this->TableVar = 't93_periode';
		$this->TableName = 't93_periode';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t93_periode`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t93_periode', 't93_periode', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Bulan
		$this->Bulan = new cField('t93_periode', 't93_periode', 'x_Bulan', 'Bulan', '`Bulan`', '`Bulan`', 16, -1, FALSE, '`Bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tahun
		$this->Tahun = new cField('t93_periode', 't93_periode', 'x_Tahun', 'Tahun', '`Tahun`', '`Tahun`', 2, -1, FALSE, '`Tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t93_periode`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t93_periodeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t93_periodeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t93_periodeadd.php?" . $this->UrlParm($parm);
		else
			$url = "t93_periodeadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t93_periodeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t93_periodeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t93_periodedelete.php", $this->UrlParm());
	}
