...
$RootMenu->AddMenuItem(10058, "mi_t10_jurnal", $Language->MenuPhrase("10058", "MenuText"), "t10_jurnallist.php", 10160, "", AllowListMenu('{C5FF1E3B-3DAB-4591-8A48-EB66171DE031}t10_jurnal'), FALSE, FALSE);
$RootMenu->AddMenuItem(10113, "mci_Laporan", $Language->MenuPhrase("10113", "MenuText"), "", -1, "", IsLoggedIn(), TRUE, TRUE);
...
$RootMenu->AddMenuItem(10056, "mi_t89_rektran", $Language->MenuPhrase("10056", "MenuText"), "t89_rektranlist.php", 35, "", AllowListMenu('{C5FF1E3B-3DAB-4591-8A48-EB66171DE031}t89_rektran'), FALSE, FALSE);
...
$RootMenu->AddMenuItem(10025, "mri_r035fjurnal", $Language->MenuPhrase("10025", "MenuText"), "r03_jurnalsmry.php", -1, "{34C67914-04B8-4CBF-A6F8-355DA216289E}", AllowListMenu('{34C67914-04B8-4CBF-A6F8-355DA216289E}r03_jurnal'), FALSE, FALSE);
$RootMenu->AddMenuItem(10026, "mri_r045fbukubesar", $Language->MenuPhrase("10026", "MenuText"), "r04_bukubesarsmry.php", -1, "{34C67914-04B8-4CBF-A6F8-355DA216289E}", AllowListMenu('{34C67914-04B8-4CBF-A6F8-355DA216289E}r04_bukubesar'), FALSE, FALSE);
$RootMenu->AddMenuItem(10018, "mri_r015fpinjaman", $Language->MenuPhrase("10018", "MenuText"), "r01_pinjamansmry.php", -1, "{34C67914-04B8-4CBF-A6F8-355DA216289E}", AllowListMenu('{34C67914-04B8-4CBF-A6F8-355DA216289E}r01_pinjaman'), FALSE, FALSE);
