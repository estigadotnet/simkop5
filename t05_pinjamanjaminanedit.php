...
ft05_pinjamanjaminanedit.ValidateRequired = true;
<?php } else { ?>
ft05_pinjamanjaminanedit.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t05_pinjamanjaminan->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_t05_pinjamanjaminan_id" class="col-sm-2 control-label ewLabel"><?php echo $t05_pinjamanjaminan->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t05_pinjamanjaminan->id->CellAttributes() ?>>
...
<?php if (!isset($t05_pinjamanjaminan_edit->Pager)) $t05_pinjamanjaminan_edit->Pager = new cPrevNextPager($t05_pinjamanjaminan_edit->StartRec, $t05_pinjamanjaminan_edit->DisplayRecs, $t05_pinjamanjaminan_edit->TotalRecs) ?>
