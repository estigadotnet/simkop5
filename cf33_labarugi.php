...
if (isset($_POST["btnproses"])) { // begin -proses-
	...
	for($i = 0; $i < count($a_akun); $i++) {
		...
		while (!$r->EOF) {
			...
			elseif (count($a_periode_lalu) == 1) {
				...
				<td>".$r->fields["id"]."</td>
				<td>".$r->fields["rekening"]."</td>
				<td>".number_format($nilaiold[0], 2)."</td>
				<td>".number_format($nilai, 2)."</td>
				</tr>
				";
			}
			elseif (count($a_periode_lalu) == 2) {
				...
				<td>".$r->fields["rekening"]."</td>
				<td>".number_format($nilaiold[0], 2)."</td>
				<td>".number_format($nilaiold[1], 2)."</td>
				<td>".number_format($nilai, 2)."</td>
				</tr>
				";
			}
	...
	<td colspan='2'>&nbsp;</td>";
	if (count($a_periode_lalu) == 0) {
		echo "<td><strong>".number_format($mtotal, 2)."</strong></td>";
		echo "</tr><tr><td colspan='3'>&nbsp;</td>";
	}
	elseif (count($a_periode_lalu) == 1) {
		echo "<td><strong>".number_format($mtotalold[0], 2)."</strong></td><td><strong>".number_format($mtotal, 2)."</strong></td>";
		echo "</tr><tr><td colspan='4'>&nbsp;</td>";
	}
	elseif (count($a_periode_lalu) == 2) {
		echo "<td><strong>".number_format($mtotalold[0], 2)."</strong></td><td><strong>".number_format($mtotalold[1], 2)."</strong></td><td><strong>".number_format($mtotal, 2)."</strong></td>";
	...
	<td colspan='2'>&nbsp;</td>";
	if (count($a_periode_lalu) == 0) {
		echo "<td><strong>".number_format($mtotal2, 2)."</strong></td>";
		echo "</tr><tr><td colspan='3'>&nbsp;</td>";
	}
	elseif (count($a_periode_lalu) == 1) {
		echo "<td><strong>".number_format($mtotal2old[0], 2)."</strong></td><td><strong>".number_format($mtotal2, 2)."</strong></td>";
		echo "</tr><tr><td colspan='4'>&nbsp;</td>";
	}
	elseif (count($a_periode_lalu) == 2) {
		echo "<td><strong>".number_format($mtotal2old[0], 2)."</strong></td><td><strong>".number_format($mtotal2old[1], 2)."</strong></td><td><strong>".number_format($mtotal2, 2)."</strong></td>";
		echo "</tr><tr><td colspan='5'>&nbsp;</td>";
	}
	echo "
	</tr>
	...
	<td colspan='2'>&nbsp;</td>";
	if (count($a_periode_lalu) == 0) {
		echo "<td><strong>".number_format($mtotal - $mtotal2, 2)."</strong></td>";
		echo "</tr><tr><td colspan='3'>&nbsp;</td>";
	}
	elseif (count($a_periode_lalu) == 1) {
		echo "<td><strong>".number_format($mtotalold[0] - $mtotal2old[0], 2)."</strong></td><td><strong>".number_format($mtotal - $mtotal2, 2)."</strong></td>";
		echo "</tr><tr><td colspan='4'>&nbsp;</td>";
	}
	elseif (count($a_periode_lalu) == 2) {
		echo "<td><strong>".number_format($mtotalold[0] - $mtotal2old[0], 2)."</strong></td><td><strong>".number_format($mtotalold[1] - $mtotal2old[1], 2)."</strong></td><td><strong>".number_format($mtotal - $mtotal2, 2)."</strong></td>";
		echo "</tr><tr><td colspan='5'>&nbsp;</td>";
	}
	echo "
	</tr>
