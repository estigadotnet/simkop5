...
$t73_pinjamanlap_add = NULL; // Initialize page object first

class ct73_pinjamanlap_add extends ct73_pinjamanlap {
	...
	// Page object name
	var $PageObjName = 't73_pinjamanlap_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t73_pinjamanlapview.php")
...
// Create page object
if (!isset($t73_pinjamanlap_add)) $t73_pinjamanlap_add = new ct73_pinjamanlap_add();

// Page init
$t73_pinjamanlap_add->Page_Init();

// Page main
$t73_pinjamanlap_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t73_pinjamanlap_add->Page_Render();
?>
...
var CurrentForm = ft73_pinjamanlapadd = new ew_Form("ft73_pinjamanlapadd", "add");

// Validate form
ft73_pinjamanlapadd.Validate = function() {
...
ft73_pinjamanlapadd.Form_CustomValidate = 
...
ft73_pinjamanlapadd.ValidateRequired = true;
<?php } else { ?>
ft73_pinjamanlapadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t73_pinjamanlap_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t73_pinjamanlap_add->ShowPageHeader(); ?>
<?php
$t73_pinjamanlap_add->ShowMessage();
?>
<form name="ft73_pinjamanlapadd" id="ft73_pinjamanlapadd" class="<?php echo $t73_pinjamanlap_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t73_pinjamanlap_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t73_pinjamanlap_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t73_pinjamanlap_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft73_pinjamanlapadd.Init();
</script>
<?php
$t73_pinjamanlap_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t73_pinjamanlap_add->Page_Terminate();
?>
