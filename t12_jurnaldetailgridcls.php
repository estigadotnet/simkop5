...
$t12_jurnaldetail_grid = NULL; // Initialize page object first

class ct12_jurnaldetail_grid extends ct12_jurnaldetail {
	...
	// Page object name
	var $PageObjName = 't12_jurnaldetail_grid';

	// Grid form hidden field names
	var $FormName = 'ft12_jurnaldetailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t12_jurnaldetail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t11_jurnalmaster") {
			$this->jurnalmaster_id->Visible = FALSE;
			if ($GLOBALS["t11_jurnalmaster"]->EventCancelled) $this->EventCancelled = TRUE;
		}
