...
class ct95_logdesc_list extends ct95_logdesc {
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->date_issued); // date_issued
			$this->UpdateSort($this->date_solved); // date_solved
...
<?php if ($t95_logdesc->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t95_logdesc->SortUrl($t95_logdesc->id) ?>',1);"><div id="elh_t95_logdesc_id" class="t95_logdesc_id">
...
<?php if ($t95_logdesc->log_id->Visible) { // log_id ?>
	...
	<?php } else { ?>
		<th data-name="log_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t95_logdesc->SortUrl($t95_logdesc->log_id) ?>',1);"><div id="elh_t95_logdesc_log_id" class="t95_logdesc_log_id">
...
<?php if ($t95_logdesc->date_issued->Visible) { // date_issued ?>
	...
	<?php } else { ?>
		<th data-name="date_issued"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t95_logdesc->SortUrl($t95_logdesc->date_issued) ?>',1);"><div id="elh_t95_logdesc_date_issued" class="t95_logdesc_date_issued">
...
<?php if ($t95_logdesc->date_solved->Visible) { // date_solved ?>
	...
	<?php } else { ?>
		<th data-name="date_solved"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t95_logdesc->SortUrl($t95_logdesc->date_solved) ?>',1);"><div id="elh_t95_logdesc_date_solved" class="t95_logdesc_date_solved">
...
<?php
	...
	if ($t95_logdesc->CurrentAction <> "gridadd")
		$t95_logdesc_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
