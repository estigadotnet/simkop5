...
$t23_deposito_edit = NULL; // Initialize page object first

class ct23_deposito_edit extends ct23_deposito {
	...
	// Page object name
	var $PageObjName = 't23_deposito_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t23_depositolist.php"); // Invalid key, return to list
		}
	...
	function ValidateForm() {
		...
		if (in_array("t24_deposito_detail", $DetailTblVar) && $GLOBALS["t24_deposito_detail"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("t24_deposito_detail", $DetailTblVar) && $GLOBALS["t24_deposito_detail"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["t24_deposito_detail_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t24_deposito_detail", $DetailTblVar)) {
				...
				if ($GLOBALS["t24_deposito_detail_grid"]->DetailEdit) {
					$GLOBALS["t24_deposito_detail_grid"]->CurrentMode = "edit";
					$GLOBALS["t24_deposito_detail_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($t23_deposito_edit)) $t23_deposito_edit = new ct23_deposito_edit();

// Page init
$t23_deposito_edit->Page_Init();

// Page main
$t23_deposito_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t23_deposito_edit->Page_Render();
?>
...
var CurrentForm = ft23_depositoedit = new ew_Form("ft23_depositoedit", "edit");

// Validate form
ft23_depositoedit.Validate = function() {
...
ft23_depositoedit.Form_CustomValidate = 
...
ft23_depositoedit.ValidateRequired = true;
<?php } else { ?>
ft23_depositoedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft23_depositoedit.Lists["x_nasabah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_bank_id[]"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t22_peserta"};
ft23_depositoedit.Lists["x_bank_id[]"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nomor","x_Pemilik","x_Bank",""],"ParentFields":["x_nasabah_id"],"ChildFields":[],"FilterFields":["x_nasabah_id"],"Options":[],"Template":"","LinkTable":"t21_bank"};
ft23_depositoedit.Lists["x_Kontrak_Status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft23_depositoedit.Lists["x_Kontrak_Status"].Options = <?php echo json_encode($t23_deposito->Kontrak_Status->Options()) ?>;
ft23_depositoedit.Lists["x_Jatuh_Tempo_Status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft23_depositoedit.Lists["x_Jatuh_Tempo_Status"].Options = <?php echo json_encode($t23_deposito->Jatuh_Tempo_Status->Options()) ?>;
ft23_depositoedit.Lists["x_Bunga_Status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft23_depositoedit.Lists["x_Bunga_Status"].Options = <?php echo json_encode($t23_deposito->Bunga_Status->Options()) ?>;
...
<?php if (!$t23_deposito_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t23_deposito_edit->ShowPageHeader(); ?>
<?php
$t23_deposito_edit->ShowMessage();
?>
<form name="ft23_depositoedit" id="ft23_depositoedit" class="<?php echo $t23_deposito_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t23_deposito_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t23_deposito_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft23_depositoedit", "x_Kontrak_Tgl", 7);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ft23_depositoedit", "x_Jatuh_Tempo_Tgl", 7);
</script>
<?php } ?>
</span>
...
<input type="hidden" data-table="t23_deposito" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t23_deposito->id->CurrentValue) ?>">
<?php
	if (in_array("t24_deposito_detail", explode(",", $t23_deposito->getCurrentDetailTable())) && $t24_deposito_detail->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t23_deposito_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft23_depositoedit.Init();
</script>
<?php
$t23_deposito_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t23_deposito_edit->Page_Terminate();
?>
