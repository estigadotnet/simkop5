...
$t74_jurnallapclosed = NULL;

//
// Table class for t74_jurnallapclosed
//
class ct74_jurnallapclosed extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't74_jurnallapclosed';
		$this->TableName = 't74_jurnallapclosed';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t74_jurnallapclosed`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Tanggal
		$this->Tanggal = new cField('t74_jurnallapclosed', 't74_jurnallapclosed', 'x_Tanggal', 'Tanggal', '`Tanggal`', ew_CastDateFieldForLike('`Tanggal`', 0, "DB"), 133, 0, FALSE, '`Tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tanggal->Sortable = TRUE; // Allow sort
		$this->Tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['Tanggal'] = &$this->Tanggal;

		// NomorTransaksi
		$this->NomorTransaksi = new cField('t74_jurnallapclosed', 't74_jurnallapclosed', 'x_NomorTransaksi', 'NomorTransaksi', '`NomorTransaksi`', '`NomorTransaksi`', 200, -1, FALSE, '`NomorTransaksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NomorTransaksi->Sortable = TRUE; // Allow sort
		$this->fields['NomorTransaksi'] = &$this->NomorTransaksi;

		// Keterangan
		$this->Keterangan = new cField('t74_jurnallapclosed', 't74_jurnallapclosed', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 200, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// AkunKode
		$this->AkunKode = new cField('t74_jurnallapclosed', 't74_jurnallapclosed', 'x_AkunKode', 'AkunKode', '`AkunKode`', '`AkunKode`', 200, -1, FALSE, '`AkunKode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AkunKode->Sortable = TRUE; // Allow sort
		$this->fields['AkunKode'] = &$this->AkunKode;

		// AkunNama
		$this->AkunNama = new cField('t74_jurnallapclosed', 't74_jurnallapclosed', 'x_AkunNama', 'AkunNama', '`AkunNama`', '`AkunNama`', 200, -1, FALSE, '`AkunNama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AkunNama->Sortable = TRUE; // Allow sort
		$this->fields['AkunNama'] = &$this->AkunNama;

		// Debet
		$this->Debet = new cField('t74_jurnallapclosed', 't74_jurnallapclosed', 'x_Debet', 'Debet', '`Debet`', '`Debet`', 4, -1, FALSE, '`Debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Kredit
		$this->Kredit = new cField('t74_jurnallapclosed', 't74_jurnallapclosed', 'x_Kredit', 'Kredit', '`Kredit`', '`Kredit`', 4, -1, FALSE, '`Kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t74_jurnallapclosed`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t74_jurnallapclosedlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t74_jurnallapclosedview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t74_jurnallapclosedview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t74_jurnallapclosedadd.php?" . $this->UrlParm($parm);
		else
			$url = "t74_jurnallapclosedadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t74_jurnallapclosededit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t74_jurnallapclosedadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t74_jurnallapcloseddelete.php", $this->UrlParm());
	}
