...
$t95_logdesc_grid = NULL; // Initialize page object first

class ct95_logdesc_grid extends ct95_logdesc {
	...
	// Page object name
	var $PageObjName = 't95_logdesc_grid';

	// Grid form hidden field names
	var $FormName = 'ft95_logdescgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t95_logdesc"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t94_log") {
			...
			if ($GLOBALS["t94_log"]->EventCancelled) $this->EventCancelled = TRUE;
		}
