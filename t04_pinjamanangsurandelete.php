...
<?php if ($t04_pinjamanangsuran->Flag_Edit->Visible) { // Flag_Edit ?>
		<th><span id="elh_t04_pinjamanangsuran_Flag_Edit" class="t04_pinjamanangsuran_Flag_Edit"><?php echo $t04_pinjamanangsuran->Flag_Edit->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($t04_pinjamanangsuran->Flag_Edit->Visible) { // Flag_Edit ?>
		<td<?php echo $t04_pinjamanangsuran->Flag_Edit->CellAttributes() ?>>
<span id="el<?php echo $t04_pinjamanangsuran_delete->RowCnt ?>_t04_pinjamanangsuran_Flag_Edit" class="t04_pinjamanangsuran_Flag_Edit">
