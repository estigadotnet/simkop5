...
$t84_saldoawal_add = NULL; // Initialize page object first

class ct84_saldoawal_add extends ct84_saldoawal {
	...
	// Page object name
	var $PageObjName = 't84_saldoawal_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t84_saldoawallist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "t84_saldoawallist.php")
						$sReturnUrl = $this->AddMasterUrl($sReturnUrl); // List page, return to list page with correct master key if necessary
					elseif (ew_GetPageName($sReturnUrl) == "t84_saldoawalview.php")
...
// Create page object
if (!isset($t84_saldoawal_add)) $t84_saldoawal_add = new ct84_saldoawal_add();

// Page init
$t84_saldoawal_add->Page_Init();

// Page main
$t84_saldoawal_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t84_saldoawal_add->Page_Render();
?>
...
var CurrentForm = ft84_saldoawaladd = new ew_Form("ft84_saldoawaladd", "add");

// Validate form
ft84_saldoawaladd.Validate = function() {
...
ft84_saldoawaladd.Form_CustomValidate = 
...
ft84_saldoawaladd.ValidateRequired = true;
<?php } else { ?>
ft84_saldoawaladd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t84_saldoawal_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t84_saldoawal_add->ShowPageHeader(); ?>
<?php
$t84_saldoawal_add->ShowMessage();
?>
<form name="ft84_saldoawaladd" id="ft84_saldoawaladd" class="<?php echo $t84_saldoawal_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t84_saldoawal_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t84_saldoawal_add->Token ?>">
<?php } ?>
...
<?php if ($t84_saldoawal->Periode->Visible) { // Periode ?>
	<div id="r_Periode" class="form-group">
		<label id="elh_t84_saldoawal_Periode" for="x_Periode" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Periode->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t84_saldoawal->Periode->CellAttributes() ?>>
<span id="el_t84_saldoawal_Periode">
<input type="text" data-table="t84_saldoawal" data-field="x_Periode" name="x_Periode" id="x_Periode" size="30" maxlength="6" placeholder="<?php echo ew_HtmlEncode($t84_saldoawal->Periode->getPlaceHolder()) ?>" value="<?php echo $t84_saldoawal->Periode->EditValue ?>"<?php echo $t84_saldoawal->Periode->EditAttributes() ?>>
</span>
<?php echo $t84_saldoawal->Periode->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t84_saldoawal->Akun->Visible) { // Akun ?>
	<div id="r_Akun" class="form-group">
		<label id="elh_t84_saldoawal_Akun" for="x_Akun" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Akun->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t84_saldoawal->Akun->CellAttributes() ?>>
<span id="el_t84_saldoawal_Akun">
<input type="text" data-table="t84_saldoawal" data-field="x_Akun" name="x_Akun" id="x_Akun" size="30" maxlength="35" placeholder="<?php echo ew_HtmlEncode($t84_saldoawal->Akun->getPlaceHolder()) ?>" value="<?php echo $t84_saldoawal->Akun->EditValue ?>"<?php echo $t84_saldoawal->Akun->EditAttributes() ?>>
</span>
<?php echo $t84_saldoawal->Akun->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t84_saldoawal->Rekening->Visible) { // Rekening ?>
	<div id="r_Rekening" class="form-group">
		<label id="elh_t84_saldoawal_Rekening" for="x_Rekening" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Rekening->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t84_saldoawal->Rekening->CellAttributes() ?>>
<span id="el_t84_saldoawal_Rekening">
<input type="text" data-table="t84_saldoawal" data-field="x_Rekening" name="x_Rekening" id="x_Rekening" size="30" maxlength="90" placeholder="<?php echo ew_HtmlEncode($t84_saldoawal->Rekening->getPlaceHolder()) ?>" value="<?php echo $t84_saldoawal->Rekening->EditValue ?>"<?php echo $t84_saldoawal->Rekening->EditAttributes() ?>>
</span>
<?php echo $t84_saldoawal->Rekening->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t84_saldoawal->Debet->Visible) { // Debet ?>
	<div id="r_Debet" class="form-group">
		<label id="elh_t84_saldoawal_Debet" for="x_Debet" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Debet->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t84_saldoawal->Debet->CellAttributes() ?>>
<span id="el_t84_saldoawal_Debet">
<input type="text" data-table="t84_saldoawal" data-field="x_Debet" name="x_Debet" id="x_Debet" size="15" placeholder="<?php echo ew_HtmlEncode($t84_saldoawal->Debet->getPlaceHolder()) ?>" value="<?php echo $t84_saldoawal->Debet->EditValue ?>"<?php echo $t84_saldoawal->Debet->EditAttributes() ?>>
</span>
<?php echo $t84_saldoawal->Debet->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t84_saldoawal->Kredit->Visible) { // Kredit ?>
	<div id="r_Kredit" class="form-group">
		<label id="elh_t84_saldoawal_Kredit" for="x_Kredit" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Kredit->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t84_saldoawal->Kredit->CellAttributes() ?>>
<span id="el_t84_saldoawal_Kredit">
<input type="text" data-table="t84_saldoawal" data-field="x_Kredit" name="x_Kredit" id="x_Kredit" size="15" placeholder="<?php echo ew_HtmlEncode($t84_saldoawal->Kredit->getPlaceHolder()) ?>" value="<?php echo $t84_saldoawal->Kredit->EditValue ?>"<?php echo $t84_saldoawal->Kredit->EditAttributes() ?>>
</span>
<?php echo $t84_saldoawal->Kredit->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t84_saldoawal->Saldo->Visible) { // Saldo ?>
	<div id="r_Saldo" class="form-group">
		<label id="elh_t84_saldoawal_Saldo" for="x_Saldo" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Saldo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t84_saldoawal->Saldo->CellAttributes() ?>>
<span id="el_t84_saldoawal_Saldo">
<input type="text" data-table="t84_saldoawal" data-field="x_Saldo" name="x_Saldo" id="x_Saldo" size="15" placeholder="<?php echo ew_HtmlEncode($t84_saldoawal->Saldo->getPlaceHolder()) ?>" value="<?php echo $t84_saldoawal->Saldo->EditValue ?>"<?php echo $t84_saldoawal->Saldo->EditAttributes() ?>>
</span>
<?php echo $t84_saldoawal->Saldo->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$t84_saldoawal_add->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t84_saldoawal_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft84_saldoawaladd.Init();
</script>
<?php
$t84_saldoawal_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t84_saldoawal_add->Page_Terminate();
?>
