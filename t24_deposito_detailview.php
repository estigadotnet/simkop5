...
$t24_deposito_detail_view = NULL; // Initialize page object first

class ct24_deposito_detail_view extends ct24_deposito_detail {
	...
	// Page object name
	var $PageObjName = 't24_deposito_detail_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t24_deposito_detaillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t24_deposito_detaillist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t24_deposito_detaillist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t24_deposito_detail_view)) $t24_deposito_detail_view = new ct24_deposito_detail_view();

// Page init
$t24_deposito_detail_view->Page_Init();

// Page main
$t24_deposito_detail_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t24_deposito_detail_view->Page_Render();
?>
...
var CurrentForm = ft24_deposito_detailview = new ew_Form("ft24_deposito_detailview", "view");

// Form_CustomValidate event
ft24_deposito_detailview.Form_CustomValidate = 
...
ft24_deposito_detailview.ValidateRequired = true;
<?php } else { ?>
ft24_deposito_detailview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$t24_deposito_detail_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t24_deposito_detail_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t24_deposito_detail_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t24_deposito_detail_view->IsModal) { ?>
...
<?php $t24_deposito_detail_view->ShowPageHeader(); ?>
<?php
$t24_deposito_detail_view->ShowMessage();
?>
<form name="ft24_deposito_detailview" id="ft24_deposito_detailview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t24_deposito_detail_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t24_deposito_detail_view->Token ?>">
<?php } ?>
...
<?php if ($t24_deposito_detail->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_t24_deposito_detail_id"><?php echo $t24_deposito_detail->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $t24_deposito_detail->id->CellAttributes() ?>>
<span id="el_t24_deposito_detail_id">
<span<?php echo $t24_deposito_detail->id->ViewAttributes() ?>>
<?php echo $t24_deposito_detail->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t24_deposito_detail->deposito_id->Visible) { // deposito_id ?>
	<tr id="r_deposito_id">
		<td><span id="elh_t24_deposito_detail_deposito_id"><?php echo $t24_deposito_detail->deposito_id->FldCaption() ?></span></td>
		<td data-name="deposito_id"<?php echo $t24_deposito_detail->deposito_id->CellAttributes() ?>>
<span id="el_t24_deposito_detail_deposito_id">
<span<?php echo $t24_deposito_detail->deposito_id->ViewAttributes() ?>>
<?php echo $t24_deposito_detail->deposito_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t24_deposito_detail->Bayar_Tgl->Visible) { // Bayar_Tgl ?>
	<tr id="r_Bayar_Tgl">
		<td><span id="elh_t24_deposito_detail_Bayar_Tgl"><?php echo $t24_deposito_detail->Bayar_Tgl->FldCaption() ?></span></td>
...
<?php echo $t24_deposito_detail->Bayar_Tgl->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t24_deposito_detail->Bayar_Jumlah->Visible) { // Bayar_Jumlah ?>
	<tr id="r_Bayar_Jumlah">
		<td><span id="elh_t24_deposito_detail_Bayar_Jumlah"><?php echo $t24_deposito_detail->Bayar_Jumlah->FldCaption() ?></span></td>
...
<?php echo $t24_deposito_detail->Bayar_Jumlah->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft24_deposito_detailview.Init();
</script>
<?php
$t24_deposito_detail_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t24_deposito_detail_view->Page_Terminate();
?>
