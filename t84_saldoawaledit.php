...
$t84_saldoawal_edit = NULL; // Initialize page object first

class ct84_saldoawal_edit extends ct84_saldoawal {
	...
	// Page object name
	var $PageObjName = 't84_saldoawal_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t84_saldoawallist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t84_saldoawal_edit)) $t84_saldoawal_edit = new ct84_saldoawal_edit();

// Page init
$t84_saldoawal_edit->Page_Init();

// Page main
$t84_saldoawal_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t84_saldoawal_edit->Page_Render();
?>
...
var CurrentForm = ft84_saldoawaledit = new ew_Form("ft84_saldoawaledit", "edit");

// Validate form
ft84_saldoawaledit.Validate = function() {
...
ft84_saldoawaledit.Form_CustomValidate = 
...
ft84_saldoawaledit.ValidateRequired = true;
<?php } else { ?>
ft84_saldoawaledit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t84_saldoawal_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t84_saldoawal_edit->ShowPageHeader(); ?>
<?php
$t84_saldoawal_edit->ShowMessage();
?>
<form name="ft84_saldoawaledit" id="ft84_saldoawaledit" class="<?php echo $t84_saldoawal_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t84_saldoawal_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t84_saldoawal_edit->Token ?>">
<?php } ?>
...
<?php if ($t84_saldoawal->Periode->Visible) { // Periode ?>
	<div id="r_Periode" class="form-group">
		<label id="elh_t84_saldoawal_Periode" for="x_Periode" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Periode->FldCaption() ?></label>
...
<input type="hidden" data-table="t84_saldoawal" data-field="x_Periode" name="x_Periode" id="x_Periode" value="<?php echo ew_HtmlEncode($t84_saldoawal->Periode->CurrentValue) ?>">
<?php echo $t84_saldoawal->Periode->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t84_saldoawal->Akun->Visible) { // Akun ?>
	<div id="r_Akun" class="form-group">
		<label id="elh_t84_saldoawal_Akun" for="x_Akun" class="col-sm-2 control-label ewLabel"><?php echo $t84_saldoawal->Akun->FldCaption() ?></label>
...
<input type="hidden" data-table="t84_saldoawal" data-field="x_Akun" name="x_Akun" id="x_Akun" value="<?php echo ew_HtmlEncode($t84_saldoawal->Akun->CurrentValue) ?>">
...
<input type="hidden" data-table="t84_saldoawal" data-field="x_Rekening" name="x_Rekening" id="x_Rekening" value="<?php echo ew_HtmlEncode($t84_saldoawal->Rekening->CurrentValue) ?>">
...
<input type="hidden" data-table="t84_saldoawal" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t84_saldoawal->id->CurrentValue) ?>">
<?php if (!$t84_saldoawal_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t84_saldoawal_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft84_saldoawaledit.Init();
</script>
<?php
$t84_saldoawal_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t84_saldoawal_edit->Page_Terminate();
?>
