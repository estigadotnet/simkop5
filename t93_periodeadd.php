...
$t93_periode_add = NULL; // Initialize page object first

class ct93_periode_add extends ct93_periode {
	...
	// Page object name
	var $PageObjName = 't93_periode_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t93_periodeview.php")
...
// Create page object
if (!isset($t93_periode_add)) $t93_periode_add = new ct93_periode_add();

// Page init
$t93_periode_add->Page_Init();

// Page main
$t93_periode_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t93_periode_add->Page_Render();
?>
...
var CurrentForm = ft93_periodeadd = new ew_Form("ft93_periodeadd", "add");

// Validate form
ft93_periodeadd.Validate = function() {
...
ft93_periodeadd.Form_CustomValidate = 
...
ft93_periodeadd.ValidateRequired = true;
<?php } else { ?>
ft93_periodeadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t93_periode_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t93_periode_add->ShowPageHeader(); ?>
<?php
$t93_periode_add->ShowMessage();
?>
<form name="ft93_periodeadd" id="ft93_periodeadd" class="<?php echo $t93_periode_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t93_periode_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t93_periode_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t93_periode_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft93_periodeadd.Init();
</script>
<?php
$t93_periode_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t93_periode_add->Page_Terminate();
?>
