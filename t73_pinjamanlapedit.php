...
$t73_pinjamanlap_edit = NULL; // Initialize page object first

class ct73_pinjamanlap_edit extends ct73_pinjamanlap {
	...
	// Page object name
	var $PageObjName = 't73_pinjamanlap_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t73_pinjamanlaplist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t73_pinjamanlaplist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "t73_pinjamanlaplist.php")
...
// Create page object
if (!isset($t73_pinjamanlap_edit)) $t73_pinjamanlap_edit = new ct73_pinjamanlap_edit();

// Page init
$t73_pinjamanlap_edit->Page_Init();

// Page main
$t73_pinjamanlap_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t73_pinjamanlap_edit->Page_Render();
?>
...
var CurrentForm = ft73_pinjamanlapedit = new ew_Form("ft73_pinjamanlapedit", "edit");

// Validate form
ft73_pinjamanlapedit.Validate = function() {
...
ft73_pinjamanlapedit.Form_CustomValidate = 
...
ft73_pinjamanlapedit.ValidateRequired = true;
<?php } else { ?>
ft73_pinjamanlapedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft73_pinjamanlapedit.Lists["x_field_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft73_pinjamanlapedit.Lists["x_field_status"].Options = <?php echo json_encode($t73_pinjamanlap->field_status->Options()) ?>;
ft73_pinjamanlapedit.Lists["x_field_align"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft73_pinjamanlapedit.Lists["x_field_align"].Options = <?php echo json_encode($t73_pinjamanlap->field_align->Options()) ?>;
ft73_pinjamanlapedit.Lists["x_field_format"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft73_pinjamanlapedit.Lists["x_field_format"].Options = <?php echo json_encode($t73_pinjamanlap->field_format->Options()) ?>;
...
<?php if (!$t73_pinjamanlap_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t73_pinjamanlap_edit->ShowPageHeader(); ?>
<?php
$t73_pinjamanlap_edit->ShowMessage();
?>
<form name="ft73_pinjamanlapedit" id="ft73_pinjamanlapedit" class="<?php echo $t73_pinjamanlap_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t73_pinjamanlap_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t73_pinjamanlap_edit->Token ?>">
<?php } ?>
...
<?php if ($t73_pinjamanlap->field_name->Visible) { // field_name ?>
	<div id="r_field_name" class="form-group">
		<label id="elh_t73_pinjamanlap_field_name" for="x_field_name" class="col-sm-2 control-label ewLabel"><?php echo $t73_pinjamanlap->field_name->FldCaption() ?></label>
...
<input type="hidden" data-table="t73_pinjamanlap" data-field="x_field_name" name="x_field_name" id="x_field_name" value="<?php echo ew_HtmlEncode($t73_pinjamanlap->field_name->CurrentValue) ?>">
...
<input type="hidden" data-table="t73_pinjamanlap" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t73_pinjamanlap->id->CurrentValue) ?>">
<?php if (!$t73_pinjamanlap_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t73_pinjamanlap_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft73_pinjamanlapedit.Init();
</script>
<?php
$t73_pinjamanlap_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t73_pinjamanlap_edit->Page_Terminate();
?>
