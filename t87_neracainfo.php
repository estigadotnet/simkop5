...
//
// Table class for t87_neraca
//
class ct87_neraca extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't87_neraca';
		$this->TableName = 't87_neraca';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t87_neraca`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// field01
		$this->field01 = new cField('t87_neraca', 't87_neraca', 'x_field01', 'field01', '`field01`', '`field01`', 200, -1, FALSE, '`field01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field01->Sortable = TRUE; // Allow sort
		$this->fields['field01'] = &$this->field01;

		// field02
		$this->field02 = new cField('t87_neraca', 't87_neraca', 'x_field02', 'field02', '`field02`', '`field02`', 200, -1, FALSE, '`field02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field02->Sortable = TRUE; // Allow sort
		$this->fields['field02'] = &$this->field02;

		// field03
		$this->field03 = new cField('t87_neraca', 't87_neraca', 'x_field03', 'field03', '`field03`', '`field03`', 200, -1, FALSE, '`field03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field03->Sortable = TRUE; // Allow sort
		$this->fields['field03'] = &$this->field03;

		// field04
		$this->field04 = new cField('t87_neraca', 't87_neraca', 'x_field04', 'field04', '`field04`', '`field04`', 200, -1, FALSE, '`field04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field04->Sortable = TRUE; // Allow sort
		$this->fields['field04'] = &$this->field04;

		// field05
		$this->field05 = new cField('t87_neraca', 't87_neraca', 'x_field05', 'field05', '`field05`', '`field05`', 200, -1, FALSE, '`field05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t87_neraca`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t87_neracaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t87_neracaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t87_neracaadd.php?" . $this->UrlParm($parm);
		else
			$url = "t87_neracaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t87_neracaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t87_neracaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t87_neracadelete.php", $this->UrlParm());
	}
