...
$t71_depositolap_edit = NULL; // Initialize page object first

class ct71_depositolap_edit extends ct71_depositolap {
	...
	// Page object name
	var $PageObjName = 't71_depositolap_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t71_depositolaplist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t71_depositolaplist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "t71_depositolaplist.php")
...
// Create page object
if (!isset($t71_depositolap_edit)) $t71_depositolap_edit = new ct71_depositolap_edit();

// Page init
$t71_depositolap_edit->Page_Init();

// Page main
$t71_depositolap_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t71_depositolap_edit->Page_Render();
?>
...
var CurrentForm = ft71_depositolapedit = new ew_Form("ft71_depositolapedit", "edit");

// Validate form
ft71_depositolapedit.Validate = function() {
...
ft71_depositolapedit.Form_CustomValidate = 
...
ft71_depositolapedit.ValidateRequired = true;
<?php } else { ?>
ft71_depositolapedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft71_depositolapedit.Lists["x_field_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft71_depositolapedit.Lists["x_field_status"].Options = <?php echo json_encode($t71_depositolap->field_status->Options()) ?>;
ft71_depositolapedit.Lists["x_field_align"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft71_depositolapedit.Lists["x_field_align"].Options = <?php echo json_encode($t71_depositolap->field_align->Options()) ?>;
ft71_depositolapedit.Lists["x_field_format"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft71_depositolapedit.Lists["x_field_format"].Options = <?php echo json_encode($t71_depositolap->field_format->Options()) ?>;
...
<?php if (!$t71_depositolap_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t71_depositolap_edit->ShowPageHeader(); ?>
<?php
$t71_depositolap_edit->ShowMessage();
?>
<form name="ft71_depositolapedit" id="ft71_depositolapedit" class="<?php echo $t71_depositolap_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t71_depositolap_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t71_depositolap_edit->Token ?>">
<?php } ?>
...
<?php if ($t71_depositolap->field_name->Visible) { // field_name ?>
	<div id="r_field_name" class="form-group">
		<label id="elh_t71_depositolap_field_name" for="x_field_name" class="col-sm-2 control-label ewLabel"><?php echo $t71_depositolap->field_name->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t71_depositolap->field_name->CellAttributes() ?>>
<span id="el_t71_depositolap_field_name">
...
<input type="hidden" data-table="t71_depositolap" data-field="x_field_name" name="x_field_name" id="x_field_name" value="<?php echo ew_HtmlEncode($t71_depositolap->field_name->CurrentValue) ?>">
<?php echo $t71_depositolap->field_name->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t71_depositolap->field_caption->Visible) { // field_caption ?>
	<div id="r_field_caption" class="form-group">
		<label id="elh_t71_depositolap_field_caption" for="x_field_caption" class="col-sm-2 control-label ewLabel"><?php echo $t71_depositolap->field_caption->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t71_depositolap->field_caption->CellAttributes() ?>>
<span id="el_t71_depositolap_field_caption">
<input type="text" data-table="t71_depositolap" data-field="x_field_caption" name="x_field_caption" id="x_field_caption" size="30" maxlength="32" placeholder="<?php echo ew_HtmlEncode($t71_depositolap->field_caption->getPlaceHolder()) ?>" value="<?php echo $t71_depositolap->field_caption->EditValue ?>"<?php echo $t71_depositolap->field_caption->EditAttributes() ?>>
</span>
<?php echo $t71_depositolap->field_caption->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t71_depositolap->field_index->Visible) { // field_index ?>
	<div id="r_field_index" class="form-group">
		<label id="elh_t71_depositolap_field_index" for="x_field_index" class="col-sm-2 control-label ewLabel"><?php echo $t71_depositolap->field_index->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t71_depositolap->field_index->CellAttributes() ?>>
<span id="el_t71_depositolap_field_index">
<input type="text" data-table="t71_depositolap" data-field="x_field_index" name="x_field_index" id="x_field_index" size="5" placeholder="<?php echo ew_HtmlEncode($t71_depositolap->field_index->getPlaceHolder()) ?>" value="<?php echo $t71_depositolap->field_index->EditValue ?>"<?php echo $t71_depositolap->field_index->EditAttributes() ?>>
</span>
<?php echo $t71_depositolap->field_index->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t71_depositolap->field_status->Visible) { // field_status ?>
	<div id="r_field_status" class="form-group">
		<label id="elh_t71_depositolap_field_status" class="col-sm-2 control-label ewLabel"><?php echo $t71_depositolap->field_status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t71_depositolap->field_status->CellAttributes() ?>>
<span id="el_t71_depositolap_field_status">
<div id="tp_x_field_status" class="ewTemplate"><input type="radio" data-table="t71_depositolap" data-field="x_field_status" data-value-separator="<?php echo $t71_depositolap->field_status->DisplayValueSeparatorAttribute() ?>" name="x_field_status" id="x_field_status" value="{value}"<?php echo $t71_depositolap->field_status->EditAttributes() ?>></div>
<div id="dsl_x_field_status" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $t71_depositolap->field_status->RadioButtonListHtml(FALSE, "x_field_status") ?>
</div></div>
</span>
<?php echo $t71_depositolap->field_status->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t71_depositolap->field_align->Visible) { // field_align ?>
	<div id="r_field_align" class="form-group">
		<label id="elh_t71_depositolap_field_align" for="x_field_align" class="col-sm-2 control-label ewLabel"><?php echo $t71_depositolap->field_align->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t71_depositolap->field_align->CellAttributes() ?>>
<span id="el_t71_depositolap_field_align">
<select data-table="t71_depositolap" data-field="x_field_align" data-value-separator="<?php echo $t71_depositolap->field_align->DisplayValueSeparatorAttribute() ?>" id="x_field_align" name="x_field_align"<?php echo $t71_depositolap->field_align->EditAttributes() ?>>
<?php echo $t71_depositolap->field_align->SelectOptionListHtml("x_field_align") ?>
</select>
</span>
<?php echo $t71_depositolap->field_align->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t71_depositolap->field_format->Visible) { // field_format ?>
	<div id="r_field_format" class="form-group">
		<label id="elh_t71_depositolap_field_format" for="x_field_format" class="col-sm-2 control-label ewLabel"><?php echo $t71_depositolap->field_format->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t71_depositolap->field_format->CellAttributes() ?>>
<span id="el_t71_depositolap_field_format">
<select data-table="t71_depositolap" data-field="x_field_format" data-value-separator="<?php echo $t71_depositolap->field_format->DisplayValueSeparatorAttribute() ?>" id="x_field_format" name="x_field_format"<?php echo $t71_depositolap->field_format->EditAttributes() ?>>
<?php echo $t71_depositolap->field_format->SelectOptionListHtml("x_field_format") ?>
</select>
</span>
<?php echo $t71_depositolap->field_format->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<input type="hidden" data-table="t71_depositolap" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t71_depositolap->id->CurrentValue) ?>">
<?php if (!$t71_depositolap_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t71_depositolap_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft71_depositolapedit.Init();
</script>
<?php
$t71_depositolap_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t71_depositolap_edit->Page_Terminate();
?>
