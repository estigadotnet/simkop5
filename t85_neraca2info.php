...
//
// Table class for t85_neraca2
//
class ct85_neraca2 extends cTable {
	var $field01;
	var $field02;
	var $field03;
	var $field04;
	...
	function __construct() {
		...
		$this->TableVar = 't85_neraca2';
		$this->TableName = 't85_neraca2';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t85_neraca2`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// field01
		$this->field01 = new cField('t85_neraca2', 't85_neraca2', 'x_field01', 'field01', '`field01`', '`field01`', 200, -1, FALSE, '`field01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field01->Sortable = TRUE; // Allow sort
		$this->fields['field01'] = &$this->field01;

		// field02
		$this->field02 = new cField('t85_neraca2', 't85_neraca2', 'x_field02', 'field02', '`field02`', '`field02`', 200, -1, FALSE, '`field02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field02->Sortable = TRUE; // Allow sort
		$this->fields['field02'] = &$this->field02;

		// field03
		$this->field03 = new cField('t85_neraca2', 't85_neraca2', 'x_field03', 'field03', '`field03`', '`field03`', 200, -1, FALSE, '`field03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field03->Sortable = TRUE; // Allow sort
		$this->fields['field03'] = &$this->field03;

		// field04
		$this->field04 = new cField('t85_neraca2', 't85_neraca2', 'x_field04', 'field04', '`field04`', '`field04`', 200, -1, FALSE, '`field04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field04->Sortable = TRUE; // Allow sort
		$this->fields['field04'] = &$this->field04;

		// field05
		$this->field05 = new cField('t85_neraca2', 't85_neraca2', 'x_field05', 'field05', '`field05`', '`field05`', 200, -1, FALSE, '`field05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t85_neraca2`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t85_neraca2view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t85_neraca2view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t85_neraca2add.php?" . $this->UrlParm($parm);
		else
			$url = "t85_neraca2add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t85_neraca2edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t85_neraca2add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t85_neraca2delete.php", $this->UrlParm());
	}
