...
$RootMenu->AddMenuItem(10548, "mmci_Laporan_28Closed29", $Language->MenuPhrase("10548", "MenuText"), "", 10451, "", IsLoggedIn(), FALSE, TRUE);
$RootMenu->AddMenuItem(10549, "mmi_cf21_jurnalclosed_php", $Language->MenuPhrase("10549", "MenuText"), "cf21_jurnalclosed.php", 10548, "", AllowListMenu('{C5FF1E3B-3DAB-4591-8A48-EB66171DE031}cf21_jurnalclosed.php'), FALSE, TRUE);
