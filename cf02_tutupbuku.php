...
$cf02_tutupbuku_php = NULL; // Initialize page object first

class ccf02_tutupbuku_php {
	...
	// Table name
	var $TableName = 'cf02_tutupbuku.php';

	// Page object name
	var $PageObjName = 'cf02_tutupbuku_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'cf02_tutupbuku.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "cf02_tutupbuku_php", $url, "", "cf02_tutupbuku_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($cf02_tutupbuku_php)) $cf02_tutupbuku_php = new ccf02_tutupbuku_php();

// Page init
$cf02_tutupbuku_php->Page_Init();

// Page main
$cf02_tutupbuku_php->Page_Main();
...
<?php
$cf02_tutupbuku_php->Page_Terminate();
?>
