...
--
-- Host: localhost
-- Generation Time: Nov 26, 2018 at 10:24 AM
...
--
-- Table structure for table `t90_rekening`
--

CREATE TABLE `t90_rekening` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `t90_rekening`
--

INSERT INTO `t90_rekening` (`id`, `group_id`, `Kode`, `NamaRekening`) VALUES
(1, 1, '1.1000', 'KAS');

-- --------------------------------------------------------

--
-- Table structure for table `t91_rekeninggroup`
--

CREATE TABLE `t91_rekeninggroup` (
  `id` int(11) NOT NULL,
  `Kode` varchar(1) NOT NULL,
  `NamaGroup` varchar(50) NOT NULL,
  `Posisi` enum('C','D') NOT NULL,
  `Laporan` enum('N','R') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `t91_rekeninggroup`
--

INSERT INTO `t91_rekeninggroup` (`id`, `Kode`, `NamaGroup`, `Posisi`, `Laporan`) VALUES
(1, '1', 'AKTIVA', 'D', 'N'),
(2, '2', 'PASIVA', 'C', 'N'),
(3, '3', 'PENDAPATAN', 'C', 'R'),
(4, '4', 'BIAYA', 'D', 'R'),
(5, '5', 'PENDAPATAN LAIN-LAIN', 'C', 'R'),
(6, '6', 'BIAYA LAIN-LAIN', 'D', 'R');
...
--
-- Indexes for table `t90_rekening`
--
ALTER TABLE `t90_rekening`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `t91_rekeninggroup`
--
ALTER TABLE `t91_rekeninggroup`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `t90_rekening`
--
ALTER TABLE `t90_rekening`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `t91_rekeninggroup`
--
ALTER TABLE `t91_rekeninggroup`
