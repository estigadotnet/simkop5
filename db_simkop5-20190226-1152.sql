...
--
-- Host: localhost:3307
-- Generation Time: Feb 26, 2019 at 05:52 AM
...
--
-- Table structure for table `t83_saldoawalold`
--

CREATE TABLE `t83_saldoawalold` (
  `id` int(11) NOT NULL,
  `Periode` varchar(6) NOT NULL,
...
--
-- Table structure for table `t84_saldoawal`
--

CREATE TABLE `t84_saldoawal` (
  `id` int(11) NOT NULL,
  `Periode` varchar(6) NOT NULL,
  `Akun` varchar(35) NOT NULL,
  `Debet` float(14,2) NOT NULL DEFAULT '0.00',
...
--
-- Indexes for table `t83_saldoawalold`
--
ALTER TABLE `t83_saldoawalold`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `t84_saldoawal`
--
ALTER TABLE `t84_saldoawal`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `t83_saldoawalold`
--
ALTER TABLE `t83_saldoawalold`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `t84_saldoawal`
--
ALTER TABLE `t84_saldoawal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
