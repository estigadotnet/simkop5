...
ft97_userlevelsdelete.ValidateRequired = true;
<?php } else { ?>
ft97_userlevelsdelete.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t97_userlevels->userlevelid->Visible) { // userlevelid ?>
		<th><span id="elh_t97_userlevels_userlevelid" class="t97_userlevels_userlevelid"><?php echo $t97_userlevels->userlevelid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t97_userlevels->userlevelname->Visible) { // userlevelname ?>
		<th><span id="elh_t97_userlevels_userlevelname" class="t97_userlevels_userlevelname"><?php echo $t97_userlevels->userlevelname->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
