...
--
-- Host: localhost:3307
-- Generation Time: Dec 03, 2018 at 04:58 PM
...
CREATE TABLE `t09_jurnaltransaksi` (
  ...
  `nomor` bigint(20) NOT NULL DEFAULT '0',
  `transaksi` varchar(35) NOT NULL DEFAULT '',
  `referensi` varchar(35) NOT NULL DEFAULT '',
  ...
  `kantor` varchar(35) NOT NULL DEFAULT '',
