...
$t95_logdesc_add = NULL; // Initialize page object first

class ct95_logdesc_add extends ct95_logdesc {
	...
	// Page object name
	var $PageObjName = 't95_logdesc_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t95_logdesclist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t95_logdescview.php")
...
// Create page object
if (!isset($t95_logdesc_add)) $t95_logdesc_add = new ct95_logdesc_add();

// Page init
$t95_logdesc_add->Page_Init();

// Page main
$t95_logdesc_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t95_logdesc_add->Page_Render();
?>
...
var CurrentForm = ft95_logdescadd = new ew_Form("ft95_logdescadd", "add");

// Validate form
ft95_logdescadd.Validate = function() {
...
ft95_logdescadd.Form_CustomValidate = 
...
ft95_logdescadd.ValidateRequired = true;
<?php } else { ?>
ft95_logdescadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft95_logdescadd.Lists["x_log_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_subj_","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t94_log"};
...
<?php if (!$t95_logdesc_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t95_logdesc_add->ShowPageHeader(); ?>
<?php
$t95_logdesc_add->ShowMessage();
?>
<form name="ft95_logdescadd" id="ft95_logdescadd" class="<?php echo $t95_logdesc_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t95_logdesc_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t95_logdesc_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ft95_logdescadd.CreateAutoSuggest({"id":"x_log_id","forceSelect":false});
</script>
</span>
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft95_logdescadd", "x_date_issued", 0);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ft95_logdescadd", "x_date_solved", 0);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t95_logdesc_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft95_logdescadd.Init();
</script>
<?php
$t95_logdesc_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t95_logdesc_add->Page_Terminate();
?>
