...
$t08_pinjamanpotongan = NULL;

//
// Table class for t08_pinjamanpotongan
//
class ct08_pinjamanpotongan extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't08_pinjamanpotongan';
		$this->TableName = 't08_pinjamanpotongan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t08_pinjamanpotongan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t08_pinjamanpotongan', 't08_pinjamanpotongan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// pinjaman_id
		$this->pinjaman_id = new cField('t08_pinjamanpotongan', 't08_pinjamanpotongan', 'x_pinjaman_id', 'pinjaman_id', '`pinjaman_id`', '`pinjaman_id`', 3, -1, FALSE, '`pinjaman_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tanggal
		$this->Tanggal = new cField('t08_pinjamanpotongan', 't08_pinjamanpotongan', 'x_Tanggal', 'Tanggal', '`Tanggal`', ew_CastDateFieldForLike('`Tanggal`', 7, "DB"), 133, 7, FALSE, '`Tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tanggal->Sortable = TRUE; // Allow sort
		$this->Tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Tanggal'] = &$this->Tanggal;

		// Keterangan
		$this->Keterangan = new cField('t08_pinjamanpotongan', 't08_pinjamanpotongan', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 201, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// Jumlah
		$this->Jumlah = new cField('t08_pinjamanpotongan', 't08_pinjamanpotongan', 'x_Jumlah', 'Jumlah', '`Jumlah`', '`Jumlah`', 4, -1, FALSE, '`Jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t08_pinjamanpotongan`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t08_pinjamanpotonganlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t08_pinjamanpotonganview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t08_pinjamanpotonganview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t08_pinjamanpotonganadd.php?" . $this->UrlParm($parm);
		else
			$url = "t08_pinjamanpotonganadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t08_pinjamanpotonganedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t08_pinjamanpotonganadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t08_pinjamanpotongandelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Inserted($rsold, &$rsnew) {
		...
		f_buatjurnal($GLOBALS["Periode"], $Kontrak_No.".PT", $rekdebet, $rsnew["Jumlah"], 0, "Potongan Pinjaman No. Kontrak ".$Kontrak_No, $rsnew["Tanggal"]);
		f_buatjurnal($GLOBALS["Periode"], $Kontrak_No.".PT", $rekkredit, 0, $rsnew["Jumlah"], "Potongan Pinjaman No. Kontrak ".$Kontrak_No, $rsnew["Tanggal"]);
	}
