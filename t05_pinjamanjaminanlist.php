...
class ct05_pinjamanjaminan_list extends ct05_pinjamanjaminan {
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_t05_pinjamanjaminan\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_t05_pinjamanjaminan',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.ft05_pinjamanjaminanlist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
