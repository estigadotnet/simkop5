...
class ct05_pinjamanjaminan_list extends ct05_pinjamanjaminan {
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.ft05_pinjamanjaminanlist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
...
<?php } ?>
<?php if ($t05_pinjamanjaminan_list->TotalRecs > 0 && (!EW_AUTO_HIDE_PAGE_SIZE_SELECTOR || $t05_pinjamanjaminan_list->Pager->Visible)) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="t05_pinjamanjaminan">
