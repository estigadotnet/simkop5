...
ft05_pinjamanjaminandelete.ValidateRequired = true;
<?php } else { ?>
ft05_pinjamanjaminandelete.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t05_pinjamanjaminan->id->Visible) { // id ?>
		<th><span id="elh_t05_pinjamanjaminan_id" class="t05_pinjamanjaminan_id"><?php echo $t05_pinjamanjaminan->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t05_pinjamanjaminan->pinjaman_id->Visible) { // pinjaman_id ?>
		<th><span id="elh_t05_pinjamanjaminan_pinjaman_id" class="t05_pinjamanjaminan_pinjaman_id"><?php echo $t05_pinjamanjaminan->pinjaman_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t05_pinjamanjaminan->jaminan_id->Visible) { // jaminan_id ?>
		<th><span id="elh_t05_pinjamanjaminan_jaminan_id" class="t05_pinjamanjaminan_jaminan_id"><?php echo $t05_pinjamanjaminan->jaminan_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
