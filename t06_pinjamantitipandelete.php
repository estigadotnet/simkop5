...
ft06_pinjamantitipandelete.ValidateRequired = true;
<?php } else { ?>
ft06_pinjamantitipandelete.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t06_pinjamantitipan->Keluar->Visible) { // Keluar ?>
		<th><span id="elh_t06_pinjamantitipan_Keluar" class="t06_pinjamantitipan_Keluar"><?php echo $t06_pinjamantitipan->Keluar->FldCaption() ?></span></th>
<?php } ?>
