...
$t73_pinjamanlap = NULL;

//
// Table class for t73_pinjamanlap
//
class ct73_pinjamanlap extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't73_pinjamanlap';
		$this->TableName = 't73_pinjamanlap';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t73_pinjamanlap`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t73_pinjamanlap', 't73_pinjamanlap', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// field_name
		$this->field_name = new cField('t73_pinjamanlap', 't73_pinjamanlap', 'x_field_name', 'field_name', '`field_name`', '`field_name`', 200, -1, FALSE, '`field_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field_name->Sortable = TRUE; // Allow sort
		$this->fields['field_name'] = &$this->field_name;

		// field_caption
		$this->field_caption = new cField('t73_pinjamanlap', 't73_pinjamanlap', 'x_field_caption', 'field_caption', '`field_caption`', '`field_caption`', 200, -1, FALSE, '`field_caption`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field_caption->Sortable = TRUE; // Allow sort
		$this->fields['field_caption'] = &$this->field_caption;

		// field_index
		$this->field_index = new cField('t73_pinjamanlap', 't73_pinjamanlap', 'x_field_index', 'field_index', '`field_index`', '`field_index`', 16, -1, FALSE, '`field_index`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// field_align
		$this->field_align = new cField('t73_pinjamanlap', 't73_pinjamanlap', 'x_field_align', 'field_align', '`field_align`', '`field_align`', 202, -1, FALSE, '`field_align`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// field_format
		$this->field_format = new cField('t73_pinjamanlap', 't73_pinjamanlap', 'x_field_format', 'field_format', '`field_format`', '`field_format`', 202, -1, FALSE, '`field_format`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t73_pinjamanlap`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t73_pinjamanlaplist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t73_pinjamanlapview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t73_pinjamanlapview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t73_pinjamanlapadd.php?" . $this->UrlParm($parm);
		else
			$url = "t73_pinjamanlapadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t73_pinjamanlapedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t73_pinjamanlapadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t73_pinjamanlapdelete.php", $this->UrlParm());
	}
