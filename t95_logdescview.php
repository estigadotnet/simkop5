...
$t95_logdesc_view = NULL; // Initialize page object first

class ct95_logdesc_view extends ct95_logdesc {
	...
	// Page object name
	var $PageObjName = 't95_logdesc_view';
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t95_logdesclist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "t95_logdesclist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t95_logdesc_view)) $t95_logdesc_view = new ct95_logdesc_view();

// Page init
$t95_logdesc_view->Page_Init();

// Page main
$t95_logdesc_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t95_logdesc_view->Page_Render();
?>
...
var CurrentForm = ft95_logdescview = new ew_Form("ft95_logdescview", "view");

// Form_CustomValidate event
ft95_logdescview.Form_CustomValidate = 
...
ft95_logdescview.ValidateRequired = true;
<?php } else { ?>
ft95_logdescview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$t95_logdesc_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t95_logdesc_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t95_logdesc_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t95_logdesc_view->IsModal) { ?>
...
<?php $t95_logdesc_view->ShowPageHeader(); ?>
<?php
$t95_logdesc_view->ShowMessage();
?>
<form name="ft95_logdescview" id="ft95_logdescview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t95_logdesc_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t95_logdesc_view->Token ?>">
<?php } ?>
...
<?php if ($t95_logdesc->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_t95_logdesc_id"><?php echo $t95_logdesc->id->FldCaption() ?></span></td>
...
<?php echo $t95_logdesc->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_logdesc->log_id->Visible) { // log_id ?>
	<tr id="r_log_id">
		<td><span id="elh_t95_logdesc_log_id"><?php echo $t95_logdesc->log_id->FldCaption() ?></span></td>
...
<?php echo $t95_logdesc->log_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t95_logdesc->date_solved->Visible) { // date_solved ?>
	<tr id="r_date_solved">
		<td><span id="elh_t95_logdesc_date_solved"><?php echo $t95_logdesc->date_solved->FldCaption() ?></span></td>
...
<?php echo $t95_logdesc->date_solved->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if (!$t95_logdesc_view->IsModal) { ?>
<?php if (!isset($t95_logdesc_view->Pager)) $t95_logdesc_view->Pager = new cPrevNextPager($t95_logdesc_view->StartRec, $t95_logdesc_view->DisplayRecs, $t95_logdesc_view->TotalRecs) ?>
<?php if ($t95_logdesc_view->Pager->RecordCount > 0 && $t95_logdesc_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t95_logdesc_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t95_logdesc_view->PageUrl() ?>start=<?php echo $t95_logdesc_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t95_logdesc_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t95_logdesc_view->PageUrl() ?>start=<?php echo $t95_logdesc_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t95_logdesc_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t95_logdesc_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t95_logdesc_view->PageUrl() ?>start=<?php echo $t95_logdesc_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t95_logdesc_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t95_logdesc_view->PageUrl() ?>start=<?php echo $t95_logdesc_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t95_logdesc_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
...
<script type="text/javascript">
ft95_logdescview.Init();
</script>
<?php
$t95_logdesc_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t95_logdesc_view->Page_Terminate();
?>
