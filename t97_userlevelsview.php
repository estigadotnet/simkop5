...
ft97_userlevelsview.ValidateRequired = true;
<?php } else { ?>
ft97_userlevelsview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t97_userlevels->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td><span id="elh_t97_userlevels_userlevelid"><?php echo $t97_userlevels->userlevelid->FldCaption() ?></span></td>
...
<?php if ($t97_userlevels->userlevelname->Visible) { // userlevelname ?>
	<tr id="r_userlevelname">
		<td><span id="elh_t97_userlevels_userlevelname"><?php echo $t97_userlevels->userlevelname->FldCaption() ?></span></td>
