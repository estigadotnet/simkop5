...
$cf14_backup_php = NULL; // Initialize page object first

class ccf14_backup_php {
	...
	// Table name
	var $TableName = 'cf14_backup.php';

	// Page object name
	var $PageObjName = 'cf14_backup_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'cf14_backup.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "cf14_backup_php", $url, "", "cf14_backup_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($cf14_backup_php)) $cf14_backup_php = new ccf14_backup_php();

// Page init
$cf14_backup_php->Page_Init();

// Page main
$cf14_backup_php->Page_Main();
...
<?php
$cf14_backup_php->Page_Terminate();
?>
