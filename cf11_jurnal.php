...
$cf11_jurnal_php = NULL; // Initialize page object first

class ccf11_jurnal_php {
	...
	// Table name
	var $TableName = 'cf11_jurnal.php';

	// Page object name
	var $PageObjName = 'cf11_jurnal_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'cf11_jurnal.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "cf11_jurnal_php", $url, "", "cf11_jurnal_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($cf11_jurnal_php)) $cf11_jurnal_php = new ccf11_jurnal_php();

// Page init
$cf11_jurnal_php->Page_Init();

// Page main
$cf11_jurnal_php->Page_Main();
...
<?php
$cf11_jurnal_php->Page_Terminate();
?>
