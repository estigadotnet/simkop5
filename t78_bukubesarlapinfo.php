...
$t78_bukubesarlap = NULL;

//
// Table class for t78_bukubesarlap
//
class ct78_bukubesarlap extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't78_bukubesarlap';
		$this->TableName = 't78_bukubesarlap';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t78_bukubesarlap`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Tanggal
		$this->Tanggal = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_Tanggal', 'Tanggal', '`Tanggal`', ew_CastDateFieldForLike('`Tanggal`', 7, "DB"), 133, 7, FALSE, '`Tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tanggal->Sortable = TRUE; // Allow sort
		$this->Tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Tanggal'] = &$this->Tanggal;

		// NomorTransaksi
		$this->NomorTransaksi = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_NomorTransaksi', 'NomorTransaksi', '`NomorTransaksi`', '`NomorTransaksi`', 200, -1, FALSE, '`NomorTransaksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NomorTransaksi->Sortable = TRUE; // Allow sort
		$this->fields['NomorTransaksi'] = &$this->NomorTransaksi;

		// Keterangan
		$this->Keterangan = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 200, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// Debet
		$this->Debet = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_Debet', 'Debet', '`Debet`', '`Debet`', 4, -1, FALSE, '`Debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Kredit
		$this->Kredit = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_Kredit', 'Kredit', '`Kredit`', '`Kredit`', 4, -1, FALSE, '`Kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Saldo
		$this->Saldo = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_Saldo', 'Saldo', '`Saldo`', '`Saldo`', 4, -1, FALSE, '`Saldo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AkunKode
		$this->AkunKode = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_AkunKode', 'AkunKode', '`AkunKode`', '`AkunKode`', 200, -1, FALSE, '`AkunKode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AkunKode->Sortable = TRUE; // Allow sort
		$this->fields['AkunKode'] = &$this->AkunKode;

		// AkunNama
		$this->AkunNama = new cField('t78_bukubesarlap', 't78_bukubesarlap', 'x_AkunNama', 'AkunNama', '`AkunNama`', '`AkunNama`', 200, -1, FALSE, '`AkunNama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AkunNama->Sortable = TRUE; // Allow sort
		$this->fields['AkunNama'] = &$this->AkunNama;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t78_bukubesarlap`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t78_bukubesarlaplist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t78_bukubesarlapview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t78_bukubesarlapview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t78_bukubesarlapadd.php?" . $this->UrlParm($parm);
		else
			$url = "t78_bukubesarlapadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t78_bukubesarlapedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t78_bukubesarlapadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t78_bukubesarlapdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		// AkunKode
		$this->AkunKode->EditAttrs["class"] = "form-control";
		$this->AkunKode->EditCustomAttributes = "";
		$this->AkunKode->EditValue = $this->AkunKode->CurrentValue;
		$this->AkunKode->PlaceHolder = ew_RemoveHtml($this->AkunKode->FldCaption());

		// AkunNama
		$this->AkunNama->EditAttrs["class"] = "form-control";
		$this->AkunNama->EditCustomAttributes = "";
		$this->AkunNama->EditValue = $this->AkunNama->CurrentValue;
		$this->AkunNama->PlaceHolder = ew_RemoveHtml($this->AkunNama->FldCaption());
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->AkunKode->Exportable) $Doc->ExportCaption($this->AkunKode);
					if ($this->AkunNama->Exportable) $Doc->ExportCaption($this->AkunNama);
				} else {
					if ($this->Tanggal->Exportable) $Doc->ExportCaption($this->Tanggal);
					if ($this->NomorTransaksi->Exportable) $Doc->ExportCaption($this->NomorTransaksi);
					if ($this->Keterangan->Exportable) $Doc->ExportCaption($this->Keterangan);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->AkunKode->Exportable) $Doc->ExportField($this->AkunKode);
						if ($this->AkunNama->Exportable) $Doc->ExportField($this->AkunNama);
					} else {
						if ($this->Tanggal->Exportable) $Doc->ExportField($this->Tanggal);
						if ($this->NomorTransaksi->Exportable) $Doc->ExportField($this->NomorTransaksi);
						if ($this->Keterangan->Exportable) $Doc->ExportField($this->Keterangan);
