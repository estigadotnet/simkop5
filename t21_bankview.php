...
$t21_bank_view = NULL; // Initialize page object first

class ct21_bank_view extends ct21_bank {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t21_banklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t21_banklist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t21_banklist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t21_bank_view)) $t21_bank_view = new ct21_bank_view();

// Page init
$t21_bank_view->Page_Init();

// Page main
$t21_bank_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t21_bank_view->Page_Render();
?>
...
var CurrentForm = ft21_bankview = new ew_Form("ft21_bankview", "view");

// Form_CustomValidate event
ft21_bankview.Form_CustomValidate = 
...
ft21_bankview.ValidateRequired = true;
<?php } else { ?>
ft21_bankview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft21_bankview.Lists["x_nasabah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_nasabah"};
...
<div class="ewToolbar">
<?php if (!$t21_bank_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t21_bank_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t21_bank_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t21_bank_view->IsModal) { ?>
...
<?php $t21_bank_view->ShowPageHeader(); ?>
<?php
$t21_bank_view->ShowMessage();
?>
<form name="ft21_bankview" id="ft21_bankview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t21_bank_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t21_bank_view->Token ?>">
<?php } ?>
...
<?php if ($t21_bank->nasabah_id->Visible) { // nasabah_id ?>
	<tr id="r_nasabah_id">
		<td><span id="elh_t21_bank_nasabah_id"><?php echo $t21_bank->nasabah_id->FldCaption() ?></span></td>
...
<?php echo $t21_bank->nasabah_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t21_bank->Nomor->Visible) { // Nomor ?>
	<tr id="r_Nomor">
		<td><span id="elh_t21_bank_Nomor"><?php echo $t21_bank->Nomor->FldCaption() ?></span></td>
...
<?php echo $t21_bank->Nomor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t21_bank->Pemilik->Visible) { // Pemilik ?>
	<tr id="r_Pemilik">
		<td><span id="elh_t21_bank_Pemilik"><?php echo $t21_bank->Pemilik->FldCaption() ?></span></td>
...
<?php echo $t21_bank->Pemilik->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t21_bank->Bank->Visible) { // Bank ?>
	<tr id="r_Bank">
		<td><span id="elh_t21_bank_Bank"><?php echo $t21_bank->Bank->FldCaption() ?></span></td>
...
<?php echo $t21_bank->Bank->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t21_bank->Kota->Visible) { // Kota ?>
	<tr id="r_Kota">
		<td><span id="elh_t21_bank_Kota"><?php echo $t21_bank->Kota->FldCaption() ?></span></td>
...
<?php echo $t21_bank->Kota->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t21_bank->Cabang->Visible) { // Cabang ?>
	<tr id="r_Cabang">
		<td><span id="elh_t21_bank_Cabang"><?php echo $t21_bank->Cabang->FldCaption() ?></span></td>
...
<?php echo $t21_bank->Cabang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
